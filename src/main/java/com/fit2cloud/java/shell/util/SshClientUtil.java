...
//    private static String DEFAULTCHART = "Utf-8";
    ...
    private static Connection login(String ip, String username, String password,int port) {
        boolean flag = false;
    ...
    public static void main(String[] args) {
        String ip = "10.254.0.192";
        String username = "administrator";
        String password = "Abc123..";
        int port =23;
        String cmd = "ipconfig";
        Connection connection = login(ip, username, password,port);
